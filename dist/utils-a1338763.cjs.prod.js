...
function getScrollParent(element) {
  ...
  for (var parent = element; parent = parent.parentElement; ) if ((!(excludeStaticParent = "static" === (style = getComputedStyle(parent)).position && excludeStaticParent) || "static" !== style.position) && overflowRx.test(style.overflow + style.overflowY + style.overflowX)) return parent;
  return docEl;
}
