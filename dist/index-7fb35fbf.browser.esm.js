...
import { g as getBoundingClientObj, a as getScrollParent, b as getScrollTop, c as animatedScrollTo, s as scrollTo } from './utils-9e419d6e.browser.esm.js';
...
function getMenuPlacement(_ref) {
  ...
  var _scrollParent$getBoun = scrollParent.getBoundingClientRect(),
      ...
      scrollParentBottom = _scrollParent$getBoun.bottom;

  var _menuEl$getBoundingCl = menuEl.getBoundingClientRect(),
      menuBottom = _menuEl$getBoundingCl.bottom,
      menuHeightBoundingRect = _menuEl$getBoundingCl.height,
      menuTop = _menuEl$getBoundingCl.top;

  var menuHeight = menuEl.style.transform ? menuEl.offsetHeight : menuHeightBoundingRect; // using the height of the scrollable parent and not the window height.

  var viewHeight = scrollParent.clientHeight;
  var scrollTop = getScrollTop(scrollParent);
  var marginBottom = parseInt(getComputedStyle(menuEl).marginBottom, 10);
  var marginTop = parseInt(getComputedStyle(menuEl).marginTop, 10);
  var viewSpaceAbove = menuTop - scrollParentTop - scrollTop;
  var viewSpaceBelow = viewHeight - menuTop;
  var scrollSpaceAbove = viewSpaceAbove + scrollTop; // scroll space left in the parent not relative to the menu

  var scrollSpaceBelow = scrollParent.scrollHeight - scrollTop - viewHeight;
  var scrollSpaceBelowMenu = scrollParentBottom - menuTop;
  ...
  switch (placement) {
    ...
    case 'bottom':
      ...
      if (!isFixedPosition && scrollSpaceBelowMenu >= minHeight && viewHeight + scrollSpaceBelow >= scrollSpaceBelowMenu || isFixedPosition && viewSpaceBelow >= minHeight) {
        if (shouldScroll) {
          animatedScrollTo(scrollParent, scrollDown, scrollDuration);
        ...
        var constrainedHeight = isFixedPosition ? viewSpaceBelow - marginBottom : Math.min(scrollSpaceBelowMenu - marginBottom, maxHeight);
        return {
          placement: 'bottom',
