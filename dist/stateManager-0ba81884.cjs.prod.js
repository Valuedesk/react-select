...
var _extends__default = _interopDefault(_extends), _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), _classCallCheck__default = _interopDefault(_classCallCheck), _createClass__default = _interopDefault(_createClass), _inherits__default = _interopDefault(_inherits), React__default = _interopDefault(React), _excluded = [ "defaultInputValue", "defaultMenuIsOpen", "defaultValue" ], defaultProps = {
  defaultInputValue: "",
  defaultMenuIsOpen: !1,
  defaultValue: null
  ...
  return _temp = _class = function(_Component) {
    ...
    return _createClass__default.default(StateManager, [ {
      ...
      value: function() {
        ...
        var props = _objectWithoutProperties__default.default(_this$props2, _excluded);
